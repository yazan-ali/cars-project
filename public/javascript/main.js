...
// carPrice=CarPrice+6000;
// $("#firstPayment").html(carPrice*0.3);
// carPriceMonthly=carPrice-carPrice*0.3;
// console.log(carPriceMonthly);
...
// $(".first-payment").click(function(){
// if($(".first-payment").val()==="40%"){
// carPrice=CarPrice+5000;
// $("#firstPayment").html(carPrice*0.4);
// carPriceMonthly=carPrice-carPrice*0.4;
// console.log(carPriceMonthly);
// $(".monthly-Payment").click(function(){
// if($(".monthly-Payment").val()==="36"){
// $("#monthlyPayment").html(Math.floor(carPriceMonthly/36));	
...
// carPrice=CarPrice+4000;
// $("#firstPayment").html(carPrice*0.5);
// carPriceMonthly=carPrice-carPrice*0.5;
// console.log(carPriceMonthly);
// $(".monthly-Payment").click(function(){
// if($(".monthly-Payment").val()==="36"){
// $("#monthlyPayment").html(Math.floor(carPriceMonthly/36));	
...
// function rest2(){
// $(".car-select").click(function(){
// // $(".displayBlock").slideUp();
// $(".first-payment").val("1")		
// $("#monthly-payment").val("1")	
// $("#firstPayment").html(0);	
